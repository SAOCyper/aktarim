mert@mertunubol:~/Development/gsc.scheduling.theia$ docker exec -it gsc-gui-web bash
root@2a85f57da0c0:/# cd home/theia/
root@2a85f57da0c0:/home/theia# npx lerna run build --scope="@uzay/*" --concurrency=1 --skip-nx-cache
