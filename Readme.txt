...
function setupAliases(config) {
    ...
    // Add alias for @uzay/gsc-core-extension to resolve from extensions folder
    config.resolve.alias['@uzay/gsc-core-extension'] = path.resolve(ROOT_NODE_MODULES, '@uzay/gsc-core-extension');
