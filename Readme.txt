...
RUN npm install --verbose && \
    npx lerna run build --scope="@uzay/*" --concurrency=1 --skip-nx-cache && \
    #npm run build:extensions --concurrency=1 --skip-nx-cache --verbose && \
...
CMD [ "--root-dir=/home/project", "--hostname=0.0.0.0", "--port=3000"]  version: '3'

services:
  gsc-gui-theia2:
    image: gsc-ci-full:1.0.5
    container_name: gsc-gui-web2
 #   volumes:
 #     - ./project:/home/project
    ...
    environment:
      - PUBLIC_ASSETS_DIR= /home/theia/data/public
      - BROKER_HOST=10.1.11.24
      - BROKER_PORT=61613
      - THEIA_SECURITY_WORKSPACE_TRUST_UNTRUSTED_FILES=open
    volumes:
      - /home/mert/Development/public:/home/theia/data/public
      - /home/mert/Development/public/mbtiles:/home/theia/data/public/mbtiles
      - /home/mert/Development/public/models:/home/theia/browser-app/lib/frontend/models
      - /home/mert/Development/public/textures:/home/theia/browser-app/lib/frontend/textures
